...
from data_loader_v2 import CustomDataset_v2
...
trainset = CustomDataset_v2("train")

trainloader = DataLoader(trainset, batch_size=batch_size, shuffle=True)

testset = CustomDataset_v2("test")
...
if __name__ == "__main__":
    ...
    train(mano_estimator, trainloader, testloader, optimizer, criterion, scheduler, epochs=200, rot_type="6d", save_model_interval=50)
